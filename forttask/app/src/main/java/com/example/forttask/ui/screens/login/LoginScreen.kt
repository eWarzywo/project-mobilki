...
@Composable
fun SaveCredentialsDialog(onDismiss: () -> Unit, onConfirm: () -> Unit) {
    AlertDialog(
...
@Composable
fun UpdateCredentialsDialog(username: String, onDismiss: () -> Unit, onConfirm: () -> Unit) {
    AlertDialog(
            onDismissRequest = onDismiss,
            title = { Text("Update Credentials") },
            text = {
                Text("Credentials for '$username' already exist. Would you like to update them?")
            },
